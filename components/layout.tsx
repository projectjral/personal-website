...
function Navbar(props: NavbarProps) {
    return (
        <div className="flex justify-center mx-auto max-w-7xl h616 pt-6">
            <nav>
...
function Footer() {
    return <footer className="pt-10 px-8 pb-16 border-t">
        <div className="flex gap-6 text-sm font-medium text-zing-600">
            <FooterLink text={"About Me"} url={"/"} />
            <FooterLink text={"Projects"} url={"/projects"} />
            <FooterLink text={"Essays"} url={"/essays"} />
        </div>
        <p className="text-sm text-zinc-400">&nbsp; 2023 John Lim. All rights reserved.</p>
    </footer>
}
